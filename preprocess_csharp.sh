...
TRAIN_DIR=csharp_data/subtrain
VAL_DIR=csharp_data/subtrain
TEST_DIR=csharp_data/subtrain
DATASET_NAME=csharp_dataset
MAX_CONTEXTS=200
...
# mkdir -p data
mkdir csharp_data/${DATASET_NAME}
...
TARGET_HISTOGRAM_FILE=csharp_data/${DATASET_NAME}/${DATASET_NAME}.histo.tgt.c2v
ORIGIN_HISTOGRAM_FILE=csharp_data/${DATASET_NAME}/${DATASET_NAME}.histo.ori.c2v
PATH_HISTOGRAM_FILE=csharp_data/${DATASET_NAME}/${DATASET_NAME}.histo.path.c2v
